...
if(isset($_REQUEST['submit']))
{
	...
	//$product = Mage::getModel('catalog/product')->loadByAttribute('sku',array('like'=>'%'.$prod_sku));
	//$product = Mage::getModel('catalog/product')->addAttributeToFilter('sku', array('like'=>$prod_sku.'%')); //filter by sku part
