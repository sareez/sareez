...
$db = mysql_select_db("hbanfvqkdv",$conn) or die("ERROR::Not connected to DATABASE");
	...
	if(isset($_REQUEST['flag']) && $_REQUEST['flag']==2)
	{
		...
		//echo $_POST["allocationstatus_id"];
