...
class Remarkety_Mgconnector_Adminhtml_InstallController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function reinstallAction()
    {
        Mage::getModel('core/config')
            ...
            ->deleteConfig('remarkety/mgconnector/installed')
    ...
    public function installAction()
    {
		...
		$this
			...
			$this->_addContent($this->getLayout()->createBlock(sprintf('mgconnector/adminhtml_install_%s', $mode)));
			$this->renderLayout();
    }
    ...
    public function completeAction()
    {
        ...
        if($redirectBack) {
            $this->_redirect('*/install/install', array('mode' => $params['data']['mode']));
        } else {
