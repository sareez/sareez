...
class KM_Shippingcarriers_Model_Fedex extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {
    ...
    public function getAllowedMethods() {
        ...
        return array('fedex' => $this->getConfigData('title'));
    }
    ...
    public function getTracking($tracking_number) {
        ...
        $path = $this->getConfigData('gateway_url') . '?shpntnum=' . $tracking_number;
        $ch = curl_init();
        ...
        if ($xmlobject) {
            ...
            $status = "";
            if (isset($xmlarray['SHIPMENTREPORT'])) {
                foreach ((array) $xmlarray['SHIPMENTREPORT'] as $k => $v) {
