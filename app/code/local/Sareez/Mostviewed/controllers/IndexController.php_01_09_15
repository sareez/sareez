...
<div class="bottom-slider-02" style="margin-left: 766px; ">
  ...
  <div class="bottom-slider-03" style="margin-left: -695.658px; ">
    ...
    <img src="<?php echo Mage::helper('catalog/image')->init($mostViewed , 'thumbnail')->resize(190, 264); ?>" width="195"> </a>
      <div>
...
<div class="bottom-slider-02" style="margin-left: 766px;">
  ...
  <div class="bottom-slider-03" style="margin-left: -695.658px;">
    ...
    <img src="<?php echo Mage::helper('catalog/image')->init($mostViewed14 , 'thumbnail')->resize(190, 264); ?>" width="195">
...
<div class="bottom-slider-02" style="margin-left: 766px;">
  ...
  <div class="bottom-slider-03" style="margin-left: -695.658px;">
    ...
    <img src="<?php echo Mage::helper('catalog/image')->init($mostViewed , 'thumbnail')->resize(190, 264); ?>" width="195">
    </a>
      <div>
        <p class="bottom-slide-price"><?php echo $_formattedActualPrice = Mage::helper('core')->currency($mostViewed->getPrice(),true,false); ?> </p>
        <a href="<?php echo $mostViewed->getProductUrl(); ?>">
...
<div class="bottom-slider-02" style="margin-left: 766px;">
  ...
  <div class="bottom-slider-03" style="margin-left: -695.658px;">
    ...
    <img src="<?php echo Mage::helper('catalog/image')->init($product_bs7 , 'thumbnail')->resize(190, 264); ?>" width="195">
...
<div class="bottom-slider-02" style="margin-left: 766px;">
  ...
  <div class="bottom-slider-03" style="margin-left: -695.658px;">
    ...
    <img src="<?php echo Mage::helper('catalog/image')->init($product_bs14 , 'thumbnail')->resize(190, 264); ?>" width="195">
  ...
  <div class="bottom-slider-01" style="margin-left: 70.3421px;">
    ...
    <div class="bottom-slider-02" style="margin-left: 766px;">
      ...
      <div class="bottom-slider-03" style="margin-left: -695.658px;">
        ...
        <img src="<?php echo Mage::helper('catalog/image')->init($product_bs30 , 'thumbnail')->resize(190, 264); ?>" width="195">
    ...
    <?php } ?>
        ...
        $_product = $obj->load($productid); 
		 ...
		 ?> 
            ...
            <img src="<?php echo Mage::helper('catalog/image')->init($_product , 'thumbnail')->resize(142, 213); ?>">
			</a>
    ...
    <?php } ?>
         <div class="img">
            ...
            <img src="<?php echo Mage::helper('catalog/image')->init($_product, 'small_image')->resize(142, 213); ?>">
            </a>
            <p align="center" class="price"> <?php echo $_formattedActualPrice = Mage::helper('core')->currency($_product->getPrice(),true,false); ?></p>
            <a href="<?php echo $_product->getProductUrl(); ?>"><p align="center" class="shop-button">SHOP NOW</p></a>
            </div>
