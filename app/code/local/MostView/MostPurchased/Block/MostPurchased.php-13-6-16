<?php
class MostView_MostPurchased_Block_MostPurchased extends Mage_Core_Block_Template
{
	public function _prepareLayout()
    {
     ...
     { 
      /*  if (!$this->hasData('mostpurchased')) {
            $this->setData('mostpurchased', Mage::registry('mostpurchased'));
        }
        return $this->getData('mostpurchased');*/
