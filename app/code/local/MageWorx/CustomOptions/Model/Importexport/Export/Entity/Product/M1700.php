        ...
        foreach ($this->_storeIdToCode as $storeId => &$storeCode) {
            ...
            foreach($options as $key => $item) {
                ...
                if ($values && is_array($values)) {
                    foreach ($values as $value) {
                        $imagePath = array();
                        $images = $item->getOptionValueImages($value->getOptionTypeId());
                        if ($images) {
            ...
            foreach ($options as $option) {
                ...
                if ($defaultStoreId == $storeId) {
                    ...
                    if ($option['price'] . ($option['price_type'] == 'percent' ? '%' : '') != $customOptions[0]['_custom_option_price']) {
                        $row['_custom_option_price'] = $option['price'] . ($option['price_type'] == 'percent' ? '%' : '');
                    }
                ...
                if ($values = $option->getValues()) {
                    ...
                    if ($defaultStoreId == $storeId) {
                        ...
                        $row['_custom_option_row_image_data']  = $firstValue['image_data'];
                        ...
                        $row['_custom_option_row_cost']  = $firstValue['cost'];
