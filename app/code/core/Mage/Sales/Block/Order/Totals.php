...
class Mage_Sales_Block_Order_Totals extends Mage_Core_Block_Template
{
    ...
    protected function _initTotals()
    {
        ...
        $this->_totals['grand_total'] = new Varien_Object(array(
            ...
            'base_value'=> $source->getBaseGrandTotal(),
        ...
        if ($this->getOrder()->isCurrencyDifferent()) {
            $this->_totals['base_grandtotal'] = new Varien_Object(array(
               ...
               /* below three lines are commented due to remove "Grand Total to be Charged" from order email on 020915 by asgar*/
			   //'value' => $this->getOrder()->formatBasePrice($source->getBaseGrandTotal()),
                //'base_value'=> $this->getOrder()->formatPrice($source->getGrandTotal()),
