...
function twitterWidget($args) {
	...
	echo $before_widget; ?>
        ...
        <p align="right"><a href="http://www.twitter.com/<?php echo $account; ?>/" class="rightlink png_crop"><?php _e('Follow us on Twitter','silesia'); ?></a></p>
		</div>
...
function twitterWidget_register(){
	wp_register_sidebar_widget('twitter-1', __('NattyWP Twitter', 'silesia'), 'twitterWidget');
	wp_register_widget_control('twitter-1', __('NattyWP Twitter', 'silesia'), 'twitterWidgetAdmin', 300, 200);
}
