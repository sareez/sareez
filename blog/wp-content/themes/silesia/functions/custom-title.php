...
function seo_meta_box() {
  add_meta_box('seo-settings',__('SEO settings', 'silesia'),'seo_meta_box_content','post','normal');
  add_meta_box('seo-settings',__('SEO settings', 'silesia'),'seo_meta_box_content','page','normal');
}
