...
/*. "ordercsv_id,"*/
 $select = "select "
		...
		. "order_status,"
		. "payment_method"
        . " from sales_flat_order_item_stitching where order_status IN ('inprogress','fraud','processing','inprocess') and download_status_process = 'N' and allocationstatus_id = '2' and allocation_date <= '".$_REQUEST['date_pick']."'";
...
*/
$header ="unique_stitching_id \t Order_id \t sku \t Manufacturer Design No. \t Manufacturer Name \t Catalog Name \t Qty \t Order Date \t Allocation Date \t Allocated By \t Product Option Type \t Option Value \t Order Status \t Payment Method". "\t";
