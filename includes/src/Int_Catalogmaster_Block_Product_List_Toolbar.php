<?php
class Int_Catalogmaster_Block_Product_List_Toolbar extends Mage_Catalog_Block_Product_List_Toolbar
{
    public function getAvailableOrders()
    {
        ...
        $t = array(
            ...
            'position'      => $this->__('Popular'),
            'name'          => $this->__('Name'),            
            'special_price'         => $this->__('Discount'),
            'exprees_shipping_available'         => $this->__('Time to Ship'),
            'price'         => $this->__('Price')
        );
