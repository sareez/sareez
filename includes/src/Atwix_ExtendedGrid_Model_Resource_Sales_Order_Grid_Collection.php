    ...
    public function getSelectCountSql()
    {
        ...
        if (Mage::app()->getRequest()->getControllerName() == 'sales_order') {
            ...
            if (count($havingCondition)) {
                $countSelect->where(
                    str_replace("group_concat(`sales_flat_order_item_stitching`.stitchingstatus_id SEPARATOR ', ')", 'sales_flat_order_item_stitching.stitchingstatus_id', $havingCondition[0])
                );
