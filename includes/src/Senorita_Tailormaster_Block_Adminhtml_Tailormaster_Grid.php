...
class Senorita_Tailormaster_Block_Adminhtml_Tailormaster_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('tailorname', array(
          'header'    => Mage::helper('tailormaster')->__('Tailor Name'),
          'align'     =>'left',
          'index'     => 'tailorname',
      ));
      ...
      $this->addColumn('address', array(
			'header'    => Mage::helper('tailormaster')->__('Tailor Address'),
			'width'     => '150px',
			'index'     => 'address',
      ));
	  
      $this->addColumn('phone', array(
          'header'    => Mage::helper('tailormaster')->__('Tailor Phone'),
          'align'     =>'left',
          'index'     => 'phone',
      ));
	  
	  $this->addColumn('created_time', array(
          'header'    => Mage::helper('tailormaster')->__('Tailor Joining Date'),
          'align'     =>'left',
          'index'     => 'created_time',
      ));
	  
	  $this->addColumn('leavingdate', array(
          'header'    => Mage::helper('tailormaster')->__('Leaving Date'),
          'align'     =>'left',
          'index'     => 'leavingdate',
      ));
