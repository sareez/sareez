    ...
    protected function _prepareColumns()
    {
        ...
        $currency = (string) Mage::getStoreConfig(Mage_Directory_Model_Currency::XML_PATH_CURRENCY_BASE);
		 ...
		 $this->addColumn('increment', array(
            'header' => $helper->__('SL NO'),         
            'index' => 'increment',           
            'renderer' => 'Inchoo_Orders_Block_Adminhtml_Sales_Order_Grid_Renderer_Increment'
        )); 
		/* ---------------correct ---------------------*/
       ...
       /*$this->addColumn('increment_id', array(
            'header' => $helper->__('Order Increment ID'),
            'index'  => 'increment_id'
        ));*/
 ...
 */
	   ...
	   $this->addColumn('products', array(
		 ...
		 /* $this->addColumn('products', array(
            'header'       => $helper->__('SKU CODE'),
            'index'        => 'products',
            'renderer' => 'Inchoo_Orders_Block_Adminhtml_Sales_Order_Grid_Renderer_Sku'
        ));*/
	    ...
	    $this->addColumn('product_status', array(
            'header'  => $helper->__('Product Status'),
            'index'   => 'status',
            'type'    => 'options',
