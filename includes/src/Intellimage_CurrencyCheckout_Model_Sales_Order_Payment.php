...
class Intellimage_CurrencyCheckout_Model_Sales_Order_Payment extends Mage_Sales_Model_Order_Payment{
    ...
    {
        return !$this->getCurrencyCode() || $this->getCurrencyCode() == $this->getOrder()->getBaseCurrencyCode() || $this->getCurrencyCode() == $this->getOrder()->getOrderCurrencyCode();
    }
}