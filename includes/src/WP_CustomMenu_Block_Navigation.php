...
class WP_CustomMenu_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawMenuItem($children, $level = 1)
    {
        ...
        foreach ($children as $child) {
			...
			//$getCategoryIds = $child->getCategoryIds();
			//$getCategoryId=$this->getCategoryIds($child);
			
			$getCategoryId=$child->getId();
			//$getCategoryId=$child->getCategoryIds();
		...
		if($getCategoryId == "227")
		{
		 $html.= '<img class="arrivals_1" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/arrivals_1.png">';
		}
		
		if($getCategoryId == "226")
		{
		 $html.= '<img class="arrivals_2" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/arrivals_2.png">';
		}
		
		if($getCategoryId == "225")
		{
		 $html.= '<img class="arrivals_3" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/arrivals_3.png">';
		}
		
		if($getCategoryId == "158")
		{
		 $html.= '<img class="arrivals_4" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/arrivals_4.png">';
		}
		
		if($getCategoryId == "127")
		{
		 $html.= '<a href="http://www.sareees.com/kids-wear/kids-salwar-kameez.html"><img class="kids_1" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kids_1.png"></a>';
		}
		
		if($getCategoryId == "128")
		{
		 $html.= '<a href="http://www.sareees.com/kids-wear/kids-lehenga-choli.html"><img class="kids_2" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kids_2.png"></a>';
		}
		
		if($getCategoryId == "129")
		{
		 $html.= '<a href="http://www.sareees.com/kids-wear/kids-sarees.html"><img class="kids_3" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kids_3.png"></a>';
		}
		
		if($getCategoryId == "130")
		{
		 $html.= '<a href="http://www.sareees.com/kids-wear/kids-dresses.html"><img class="kids_4" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kids_4.png"></a>';
		}
		
		if($getCategoryId == "124")
		{
		 $html.= '<img class="accessories_1" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/accessories_1.png">';
		}
		
		if($getCategoryId == "123")
		{
		 $html.= '<img class="accessories_2" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/accessories_2.png">';
		}
		
		if($getCategoryId == "122")
		{
		 $html.= '<img class="accessories_3" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/accessories_3.png">';
		}
		
		if($getCategoryId == "125")
		{
		 $html.= '<img class="accessories_4" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/accessories_4.png">';
		}
		
		if($getCategoryId == "148")
		{
		 $html.= '<img class="jewellery_1" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/jewellery_1.png">';
		}
		
		if($getCategoryId == "108")
		{
		 $html.= '<img class="jewellery_2" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/jewellery_2.png">';
		}
		
		if($getCategoryId == "104")
		{
		 $html.= '<img class="jewellery_3" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/jewellery_3.png">';
		}
		
		if($getCategoryId == "103")
		{
		 $html.= '<img class="jewellery_4" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/jewellery_4.png">';
		}
		
		if($getCategoryId == "152")
		{
		 $html.= '<img class="kurti_2" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kurti_2.png">';
		}
		
		if($getCategoryId == "151")
		{
		 $html.= '<img class="kurti_1" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kurti_1.png">';
		}
		if($getCategoryId == "88")
		{
		 $html.= '<a href="http://www.sareees.com/kurti/embroidered-kurti.html"><img class="kurti_3" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kurti_3.png"></a>';		 
		}
		
		if($getCategoryId == "89")
		{
		 $html.= '<a href="http://www.sareees.com/kurti/printed-kurti.html"><img class="kurti_4" alt="Sareez" src="http://www.sareees.com/skin/frontend/default/sareez/images/kurti_4.png"></a>';
		}
		
		
        $html.= $getCategoryId.'</div>';
        return $html;
    }
