...
class Craig_Chinmay_RedirectController extends Mage_Core_Controller_Front_Action {
    ...
    public function indexAction() {
        $this->loadLayout();
        $block = $this->getLayout()->createBlock('Chinmay/redirect');
    ...
    public function successAction() {
        ...
        $hashSid = Mage::getStoreConfig('payment/Chinmay/sid');
        $hashTotal = number_format($order->getGrandTotal(), 2, '.', '');

        if (Mage::getStoreConfig('payment/Chinmay/demo') == '1') {
            $hashOrder = '1';
        } else {
