...
class Craig_Chinmay_NotificationController extends Mage_Core_Controller_Front_Action {
    ...
    public function insAction() {
        ...
        $invoice_on_fraud = Mage::getStoreConfig('payment/Chinmay/invoice_on_fraud');
        $invoice_on_order = Mage::getStoreConfig('payment/Chinmay/invoice_on_order');
        $hashSecretWord = Mage::getStoreConfig('payment/Chinmay/secret_word');
