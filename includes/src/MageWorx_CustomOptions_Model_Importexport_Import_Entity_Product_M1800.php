...
//            $nextOptionId   = Mage::getSingleton('importexport/resource_helper_mysql4')->getNextAutoincrement($optionTable);
//            $nextValueId    = Mage::getSingleton('importexport/resource_helper_mysql4')->getNextAutoincrement($typeValueTable);
            ...
            foreach ($bunch as $rowNum => $rowData) {
                ...
                if (!isset($customOptions['product_id'][$productId])) { // for update product entity table
                    $customOptions['product_id'][$productId] = array(
                        ...
                        // APO additions block
                        'absolute_price' => $rowData['_absolute_price'],
                        'absolute_weight' => $rowData['_absolute_weight'],
                        'sku_policy' => $rowData['_sku_policy'],
                ...
                if ($rowIsMain) {
                    $solidParams = array(
                        ...
                        'sku_policy' => $rowData['_custom_option_sku_policy']
                    );
