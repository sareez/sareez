...
function fme_layered_make_request()
{
    ...
    pageurl = $('fme_layered_url').value + '?' + $('fme_layered_params').value;
...
function fme_layered_dt_listener(evt) {
    ...
    if(e.hasClassName('fme_layered_dt_selected'))
    {
        e.removeClassName('fme_layered_dt_selected');
        e.addClassName('fme_layered_dt_unselected');
    }
    else
    {
        e.removeClassName('fme_layered_dt_unselected');
        e.addClassName('fme_layered_dt_selected');
    }
