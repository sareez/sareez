...
{var self=this;var text=$('option:selected',self.$category).text();self.$categoryText.html(text);$('.UI-NAV-INPUT').css('padding-left',self.$categoryText.width()+35);$('.UI-CATEGORY').css('width',self.$categoryText.width()+35);self.result='';},onKeydown:function(e)
